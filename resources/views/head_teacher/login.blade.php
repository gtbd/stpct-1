...
@section('title', 'Head Teacher Login')
@section('content')
        ...
        <div class="col-md-4">
            ...
            <div class="card" style="width: 30vw; height: 70vh">
                <div class="card-header">
                    <i class="fas fa-chalkboard-teacher"></i> Head Teacher Login
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('head_teacher.login') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-treemoss">
                                Login
                            </button>
