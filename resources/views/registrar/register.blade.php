    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registrar.register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="sufix_name" class="col-md-4 col-form-label text-md-right">{{ __('Suffix Name') }}</label>

                            <div class="col-md-6">
                                <input id="sufix_name" type="text" class="form-control{{ $errors->has('sufix_name') ? ' is-invalid' : '' }}" name="sufix_name" value="{{ old('sufix_name') }}" required autofocus>

                                @if ($errors->has('sufix_name'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('sufix_name') }}</strong>
                                </span>
                                @endif
                            </div>
                        </div>
